        ...
        <div className='mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[480px] lg:p-8'>
          ...
          <Card className='mx-auto mt-8 max-w-md p-6'>
            ...
            <div className='mt-4 text-center text-sm'>
              <div className='my-3 flex w-full max-w-sm items-center space-x-4'>
                <div className='relative w-full'>
                  <Input
                    ...
                    disabled
                    className='w-full rounded border border-r-0 border-gray-300 p-2 pr-16 placeholder:text-xs'
                    placeholder='Setup key'
                  />
                  <Button
                    onClick={handleCopy}
                    className='absolute right-1 top-1/2 -translate-y-1/2 rounded  p-1 text-xs text-white'
                  >
                    Copy
                  </Button>
                </div>
                ...
                <div className='mt-2 flex justify-center space-x-4'>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <IconBrandAndroid size={32} color='black' />{' '}
                        {/* Android icon */}
                        <span className='text-xs'>Android</span>
                      </a>
                    </TooltipTrigger>
                    <TooltipContent side='left' className='w-50 mr-4'>
                      <p>
                        For Android users:
                        <br /> Download the Google Authenticator app <br /> from
                        the Play Store to complete setup.
                      </p>
                    </TooltipContent>
                  </Tooltip>

                  {/* iOS Link and Tooltip */}
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <a
                        ...
                        className='flex flex-col items-center'
                      >
                        <IconBrandAppleFilled size={32} color='black' />{' '}
                        {/* iOS icon */}
                    ...
                    <TooltipContent side='right' className='w-50'>
                      <p>
                        For iOS users:
                        <br /> Download the Google Authenticator app
                        <br />
                        from the App Store to complete setup.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
